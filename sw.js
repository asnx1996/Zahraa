/* ═══════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════ */
/* ⚠️ ارفع الرقم مع كل تعديل جوهري على index.html أو admin.html.
   الاستراتيجية «الشبكة أول» فالنسخة الجديدة توصل عادةً، بس النسخة
   المخزونة هي اللي تنعرض أوفلاين — وبدون رفع الرقم تبقى القديمة. */
const V     = 'cz-v6';
